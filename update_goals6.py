...
# Replace the content of the Add Modal
# Between <div className="flex flex-col gap-4 pb-0 no-scrollbar"> and <AnimatePresence> (where SlideToSubmit is)

old_form = r"""              <div className="flex flex-col gap-4 pb-0 no-scrollbar">
                <input
                  type="text"
                  maxLength=\{100\}
                  placeholder="Título do seu objetivo: limite 100 caracteres"
                ...
                <AnimatePresence>
                \{newGoalTitle.trim\(\) !== '' && selectedTaskIds.length > 0 && newGoalStartDate !== '' && newGoalEndDate !== '' && \(
                  <motion.div
                  ...
                  >
                    <SlideToSubmit 
                      ...
                      disabled=\{isSaving\}
                      text=\{editingGoalId \? 'Salvar Alterações' : 'Salvar meu objetivo'\}
                    \/>
                  <\/motion.div>
                \)\}
                <\/AnimatePresence>
